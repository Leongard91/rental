...
class NewUserForm(forms.Form):
    username = forms.CharField(label='', max_length=40, widget=forms.TextInput(attrs={'placeholder': 'Usename (required)', 'class': 'form-control'}))
    password = forms.CharField(label='', max_length=40, widget=forms.PasswordInput(attrs={'placeholder' : 'Password (required)', 'class': 'form-control'}))
    confirmation = forms.CharField(label='', max_length=40, widget=forms.PasswordInput(attrs={'placeholder' : 'Confinrm Password (required)', 'class': 'form-control'}))
    ...
    phone = forms.CharField(label='', max_length=20, min_length=8, widget=forms.TextInput(attrs={'placeholder' : "Phone Number (required)", 'class': 'form-control'}))
    ...
    about = forms.CharField(label='', max_length=500, required=False, widget=forms.Textarea(attrs={'placeholder' : "Tell about You", 'class': 'form-control'}))
